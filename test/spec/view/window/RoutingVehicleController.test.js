Ext.Loader.syncRequire([
  'Ors.window.RoutingVehicleController',
  'Ors.window.RoutingVehicle'
]);

describe('Ors.window.RoutingVehicleController', function () {
  describe('Basics', function () {
    it('is defined', function () {
      expect(Ors.window.RoutingVehicleController).to.not.be(undefined);
    });
  });
  ...
  describe('#onSubmit', function () {
    ...
    beforeEach(function () {
      ...
      comp = Ext.create('Ors.window.RoutingVehicle', {
        vehicle: {
          start: {
            address: 'foo',
            longitude: 1,
