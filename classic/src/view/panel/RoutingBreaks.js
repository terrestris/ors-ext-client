 ...
 */
/**
 * @class Ors.view.panel.RoutingBreaks
 */
Ext.define('Ors.view.panel.RoutingBreaks', {
  ...
  requires: [
    ...
    'Ors.view.panel.RoutingBreak',
    'Ors.store.RoutingBreaks'
  ],
  ...
  buttons: [{
    ...
    handler: function (btn) {
      var routingBreaks = btn.up('ors-panel-routing-breaks');
      if (!routingBreaks) {
        return;
      }
  ...
  initComponent: function () {
    ...
    if (!me.store) {
      me.store = Ext.create('Ors.store.RoutingBreaks');
    }
