 ...
 */
/**
 * @class Ors.view.window.RoutingJob
 */
Ext.define('Ors.view.window.RoutingJob', {
  ...
  controller: 'ors-window-routing-job',
  ...
  initComponent: function () {
    ...
    var ctx = BasiGX.view.component.Map.guess().appContext.data.merge;
    if (!ctx) {
      ctx = {};
    }
    var routingOpts = ctx.routing;
