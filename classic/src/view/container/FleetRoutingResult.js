 ...
 */
/**
 * @class Ors.view.container.FleetRoutingResult
 */
Ext.define('Ors.view.container.FleetRoutingResult', {
  ...
  requires: [
    ...
    'Ext.button.Button',
    'Ors.view.container.FleetRoutingResultController',
    'Ors.view.panel.ElevationProfile',
    'Ors.util.OpenRouteService',
    'Ors.util.Date'
  ],

  controller: 'ors-container-fleetroutingresult',
