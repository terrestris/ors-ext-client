 ...
 */
/**
 * @class Ors.view.form.ClassicRoutingSettings
 */
Ext.define('Ors.view.form.ClassicRoutingSettings', {
    ...
    requires: [
        ...
        'Ors.view.form.ClassicRoutingSettingsController',
        'Ors.view.button.AvoidArea',
        'Ors.view.button.RoutingPreference'
    ],
