 ...
 */
/**
 * @class Ors.view.form.IsochroneRoutingSettings
 */
Ext.define('Ors.view.form.IsochroneRoutingSettings', {
  extend: 'Ext.form.Panel',
  xtype: 'ors-form-isochrone-routing-settings',

  requires: [
    'Ors.view.form.field.GeocodingCombo',
    'Ors.view.button.RoutingProfile',
    'Ors.view.form.IsochroneRoutingSettingsController',
