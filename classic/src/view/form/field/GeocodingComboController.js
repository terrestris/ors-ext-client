 ...
 */
/**
 * @class Ors.view.form.field.GeocodingComboController
 */
Ext.define('Ors.view.form.field.GeocodingComboController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.ors-form-field-geocodingcombo',
  ...
  onComboChange: function (combo, newValue) {
    ...
    if (isValidCoordinate) {
      ...
      Ors.util.Geocoding.doReverseGeocoding(longitude, latitude, lang)
      ...
      Ors.util.Geocoding.doGeocoding(newValue, lang)
        .then(function (resultJson) {
          // clear geocoding suggestions
          geoCodingSuggestions.removeAll();
          me.createGeoCodingSuggestions(resultJson, geoCodingSuggestions);
  ...
  createGeoCodingSuggestions: function (resultJson, geoCodingSuggestions, recId) {
    ...
    Ext.each(resultJson.features, function (feature) {
      ...
      var address = Ors.util.Geocoding.createPlaceString(feature.properties);
