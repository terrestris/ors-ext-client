 ...
 */
/**
 * @class Ors.view.form.field.GeocodingCombo
 */
Ext.define('Ors.view.form.field.GeocodingCombo', {
  extend: 'Ext.form.field.ComboBox',
  xtype: 'ors-form-field-geocodingcombo',

  requires: [
    'Ors.view.form.field.GeocodingComboController'
  ],

  controller: 'ors-form-field-geocodingcombo',
