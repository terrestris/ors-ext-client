 ...
 */
/**
 * @class Ors.window.RoutingVehicle
 */
Ext.define('Ors.window.RoutingVehicle', {
  ...
  controller: 'ors-window-routing-vehicle',
  ...
  viewModel: {
    data: {
      i18n: {
        ...
        startLabel: 'Start',
        startPlaceholder: 'Address or Coordinates',
        endLabel: 'End',
        endPlaceholder: 'Address or Coordinates',
        startDayLabel: 'Start Day',
        dayPlaceholder: 'Start Day',
        timePlaceholder: 'Time',
        endDayLabel: 'End Day',
        breaksLabel: 'Breaks',
        geocodingErrorText: 'Geocoding Error',
        timeWindowErrorText: 'Time Window Error',
        windowErrorText: 'Window Error',
        startDayBiggerErrorText: 'Start Day must be earlier than End Day',
        startTimeBiggerErrorText: 'Start Time must be earlier than End Time',
        endDayBiggerErrorText: 'End Day must be later than Start Day',
        endTimeBiggerErrorText: 'End Time must be later than Start Time'
      }
    }
  },
  ...
  items: [{
    ...
    items: [{
      ...
      items: [
        {
          ...
          flex: 1,
          validator: function () {
            var window = this.up('ors-window-routing-vehicle');
            var vm = window.getViewModel();
            var endField = window.down('ors-form-field-geocodingcombo[name=end]');
        ...
        },
        {
          ...
          handler: function (button) {
            var textField = button.up().down('ors-form-field-geocodingcombo');
            if (!textField) {
              return;
            }
            textField.reset();
      ...
      items: [
        {
          ...
          validator: function () {
            var window = this.up('ors-window-routing-vehicle');
            var vm = window.getViewModel();
            var startField = window.down('ors-form-field-geocodingcombo[name=start]');
      ...
      xtype: 'ors-panel-routing-breaks',
      header: false,
      name: 'breaks',
      maxHeight: 400
    }]
  ...
  listeners: {
    ...
    beforedestroy: function () {
      var fleetRoutingWindow = Ext.ComponentQuery.query('ors-window-fleet-routing')[0];
