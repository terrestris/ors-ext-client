 ...
 */
/**
 * @class Ors.view.button.ElevationProfileSwitcherController
 */
Ext.define('Ors.view.button.ElevationProfileSwitcherController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ors-button-elevationprofileswitcher',
    ...
    getLegendTreeStore: function() {
        var legendTree = Ext.ComponentQuery.query('o-panel-routing-legendtree')[0];
        if (!legendTree) {
            return;
        }
    ...
    onItemClick: function(layerName, propKey) {
        ...
        var elevationProfile = view.up('ors-panel-elevationprofile');
        if (!elevationProfile) {
            return;
        }
