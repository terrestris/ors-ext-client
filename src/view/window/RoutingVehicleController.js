 ...
 */
/**
 * @class Ors.window.RoutingVehicleController
 */
Ext.define('Ors.window.RoutingVehicleController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.ors-window-routing-vehicle',
  requires: [
    'Ext.Object',
    'Ext.Array',
    'Ext.ComponentQuery',
    ...
    if (breaksComp) {
      ...
      if (breaksStore) {
        ...
        var filteredBreakRecords = Ext.Array.filter(breaksStore.getData().items, function (b) {
          ...
          if (!notEmpty) {
            var breakComp = breaksComp.down('ors-panel-routing-break[recId=' + b.get('id') + ']');
