 ...
 */
/**
 * @class Ors.store.RoutingVehicles
 */
Ext.define('Ors.store.RoutingVehicles', {
  extend: 'Ext.data.Store',

  requires: [
    'Ext.Object',
    'Ors.model.RoutingVehicle'
  ],

  alias: 'store.ors-routingvehicles',

  model: 'Ors.model.RoutingVehicle',
