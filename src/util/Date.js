...
Ext.define('Ors.util.Date', {
  ...
  statics: {
     ...
     * @param {String} [Ors.util.Date.DEFAULT_DATE_FORMAT] dateFormat The
     ...
     *     Ors.util.Date.DEFAULT_DATE_FORMAT.
    ...
    getFormattedDate: function (momentDate, dateFormat, timeReferenceAware, ignoreSuffix) {
      ...
      if (timeReferenceAware) {
        dateClone = Ors.util.Date
          .getTimeReferenceAwareMomentDate(dateClone);
      }

      dateFormat = dateFormat || Ors.util.Date.DEFAULT_DATE_FORMAT;
