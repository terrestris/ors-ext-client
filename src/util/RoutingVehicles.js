 ...
 *
 * @class Ors.util.RoutingVehicles
 */
Ext.define('Ors.util.RoutingVehicles', {
  ...
  statics: {
    ...
    getGeocodingLocations: function (vehicle, lang) {
      ...
      var doReverseGeocoding = Ors.util.Geocoding.doReverseGeocoding;
    ...
    setStartEndFromGeocoding: function (vehicle, geocodingLocations) {
      var createPlaceString = Ors.util.Geocoding.createPlaceString;
