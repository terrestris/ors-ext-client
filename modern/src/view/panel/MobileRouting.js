 ...
 */
/**
 * @class Ors.view.panel.MobileRouting
 */
Ext.define('Ors.view.panel.MobileRouting', {
  extend: 'Ors.view.panel.MobilePanel',
  ...
  requires: [
    ...
    'Ors.view.panel.MobileRoutingController',
    'Ors.view.window.ClassicRoutingModel',
    'Ors.view.form.ClassicRoutingSettings'
  ],
