 ...
 */
/**
 * @class Ors.view.panel.MobileRoutingController
 */
Ext.define('Ors.view.panel.MobileRoutingController', {
  extend: 'Ors.view.window.ClassicRoutingController',
  alias: 'controller.ors-panel-mobilerouting',
  ...
  onComputeRouteClick: function () {
    ...
    var onSuccess = function (json) {
      var menu = Ext.ComponentQuery.query('ors-panel-mobilemenu')[0];
      if (menu) {
        menu.hide();
      }
