 ...
 */
/**
 * @class Ors.view.container.RoutingResult
 */
Ext.define('Ors.container.RoutingResult', {
  ...
  requires: [
    ...
    'Ors.container.ModernRoutingResultController',
    'Ors.container.LockableCarousel',
    'Ors.window.ClassicRoutingModel',
    'Ors.container.ElevationProfile',
    'Ors.util.OpenRouteService'
  ],

  controller: 'ors-container-modernroutingresult',
